...
double _calcul_erreur(const std::array<std::optional<Eigen::Vector2d>, 4>& beacons, const Eigen::Vector3d& position, const std::array<Eigen::Vector2d, 4>& fixed_beacons);
