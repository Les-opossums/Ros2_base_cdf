...
class ObstacleAvoider(Node):
    ...
    def _init_parameters(self) -> None:
        ...
        self.angle_correction = (
            self.get_parameter("angle_correction").get_parameter_value().double_value
        )
        ...
        self.cone_range = int(np.pi * self.cone_range / (180 * self.angle_increment))
        self.thickness = (
    ...
    def goal_position_callback(self, msg) -> None:
        ...
        self.get_logger().info("I received a goal position")
        self.goal_position = (
            msg.goal_position
